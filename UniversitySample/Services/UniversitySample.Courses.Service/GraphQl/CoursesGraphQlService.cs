...
namespace UniversitySample.Courses.Service.GraphQl
{
    public class CoursesGraphQlService: ICourseService
    {
        private readonly CourseProvider _provider;
        private readonly ILogger<CourseService> _logger;

        public CoursesGraphQlService(CourseProvider provider, ILogger<CourseService> logger)
        {
            _provider = provider;
            _logger = logger;
        }
